...
// NOTE: including `init` prefix
export const BECH_ADDR_20_LENGTH = 43
export const BECH_ADDR_32_LENGTH = 63

// NOTE: including `0x` prefix
export const HEX_ADDR_20_LENGTH = 42
export const HEX_ADDR_32_LENGTH = 66
...
export const zAddr = z.union([zBechAddr20, zBechAddr32, zHexAddr20, zHexAddr32])
